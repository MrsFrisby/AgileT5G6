...
if ( (typeof os_appStates !== 'undefined' && os_appStates.theme == 0) || window.location.search.search(/[?&]theme=0(?:$|&)/) !== -1) {
	...
	theme = 1;
	// Light theme
	document.documentElement.style.setProperty('--background_default', '#fefefe');								   
	document.documentElement.style.setProperty('--text_default', '#111');
	document.documentElement.style.setProperty('--text_subtitle', '#777');
	document.documentElement.style.setProperty('--text_placeholder', '#c4c4c5');
	...
	document.documentElement.style.setProperty('--shadow_button', 'rgba(120,120,120,0.3)');
